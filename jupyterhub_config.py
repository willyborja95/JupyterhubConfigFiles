...
#Se importa la clase GitHubOAuthenticator
from oauthenticator.github import GitHubOAuthenticator
#Se fija que la autenticación de usuarios se realizará utilizando GitHubOAuthenticator
c.JupyterHub.authenticator_class = GitHubOAuthenticator

#Se especifica la dirección de callback
c.GitHubOAuthenticator.oauth_callback_url = 'http://bfc8b11b.ngrok.io/hub/oauth_callback'
#Se especifica el parámetro client id
c.GitHubOAuthenticator.client_id = '8b7eb03ba01537601572'
#Se especifica el parámetro secret id
c.GitHubOAuthenticator.client_secret = '93bd4db5a30efd8895ff77799166d361e3db391b'

#Se especifica que DockerSpawner será el tipo de spawner a utilizarse 
c.JupyterHub.spawner_class='dockerspawner.DockerSpawner'
#Se especifica la dirección en donde se encuentra el archivo SudoSpawner
c.SudoSpawner.sudospawner_path = '~/bin/sudospawner'
#Se especifica que dentro de la red interna se utilizarán direcciones ip locales
c.DockerSpawner.use_internal_ip = True
#Se especifica que los contenedores Docker que se crearán pertenecerán a la red “jupyterhub-network”
c.DockerSpawner.network_name = 'jupyterhub-network'
c.DockerSpawner.extra_host_config = { 'network_mode': 'jupyterhub-network'}
#Se especifica que el contenedor que servirá de base para crear las nuevas imágenes será el de jupyterhub/singleuser versión 0.9.4
c.DockerSpawner.image = 'jupyterhub/singleuserfailtest:0.9.4'

#Se especifica que la imagen de cada usuario sea almacenada en la siguiente dirección local
notebook_dir = '/home/jupyterhub/singleuser'
c.DockerSpawner.notebook_dir = notebook_dir
#Se establece una correspondencia entre usuario y la dirección en la que se encuentra almacenada la imagen
c.DockerSpawner.volumes = { 'jupyterhub-user-{username}': notebook_dir }
#Se especifica que cuando el usuario cierre sesión, su  imagen de jupyterhub será removida
c.DockerSpawner.remove_containers = True

#Se especifica que cada imagen iniciará su ejecución con el archivo start-singleuser.sh
spawn_cmd = os.environ.get('DOCKER_SPAWN_CMD', "start-singleuser.sh")
c.DockerSpawner.extra_create_kwargs.update({ 'command': spawn_cmd })
#Se especifica que cada imagen de usuario se conectará al gateway de dirección 172.18.0.1
...
#c.JupyterHub.data_files_path = '/home/jupyterhub/Documents/jupyterhubEnvironment/share/jupyterhub'
